...
date_part('week', '2019-01-01 18:37:12 EST'::timestamptz) AS "week",
date_part('quarter', '2019-06-01 18:37:12 EST'::timestamptz) AS "quarter",
...
SELECT make_timestamptz(2018, 2, 22, 18, 4, 30.3, 'Africa/Johannesburg');
...
FROM 'C:\Users\Bernard Heinze\Documents\Code College\PostgreSQL\Chapters\Chapter 11 Dates and Times\yellow_tripdata_2016_06_01.csv'
...
SELECT 
	segment,
	to_char(departure, 'dd-mm-yyyy HH12:MI a.m TZ') AS departure,
