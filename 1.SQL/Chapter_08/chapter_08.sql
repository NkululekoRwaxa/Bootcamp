...
FROM 'C:\Users\Bernard Heinze\Documents\Code College\PostgreSQL\Chapters\Chapter 08 Grouping and Summarizing\pls_fy2014_pupld14a.csv'
WITH (FORMAT CSV, HEADER);

-- 2009 Libabry Data Table
...
FROM 'C:\Users\Bernard Heinze\Documents\Code College\PostgreSQL\Chapters\Chapter 08 Grouping and Summarizing\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER)
...
SELECT sum(visits) AS visits_2014 FROM pls_fy2014_pupld14a
WHERE visits >= 0;

SELECT sum(visits) AS visits_2009 FROM pls_fy2009_pupld09a
WHERE visits >= 0;
