...
FROM 'C:\Users\Bernard Heinze\Documents\Code College\PostgreSQL\Chapters\Chapter 09 Inspecting and Modifying Data\MPI_Directory_by_Establishment_Name.csv'
...
-- create back up before modifying a table
CREATE TABLE meat_poultry_egg_inspect_backup AS
SELECT * FROM meat_poultry_egg_inspect

-- confirm backup by looking at number of rows
SELECT
...
-- Restoring Original Values - if a mistake was made
UPDATE meat_poultry_egg_inspect
SET st = st_copy;
...
UPDATE meat_poultry_egg_inspect SET zip_copy = zip;
...
COPY state_regions
FROM 'C:\Users\Bernard Heinze\Documents\Code College\PostgreSQL\Chapters\Chapter 09 Inspecting and Modifying Data\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
